...
static const char *fonts[]          = { "JetBrains Mono:size=15","JetBrainsMono Nerd Font:size=15","NotoColorEmoji:pixelsize=15:antialias=true:autohint=true", "JoyPixels:pixelsize=20:antialias=true:autohint=true", "Font Awesome 7 Free:size=15:antialias=true:autohint=true", "Font Awesome 7 Brands Regular:size=15","monospace:size=10" };
...
static const Key keys[] = {
	...
	TAGKEYS(                        XK_9,                      8)
       ...
       { 0, XK_Print,            spawn, SHCMD("maim  ~/pix/ss/full_$(date +%F_%H-%M-%S).png && notify-send 'Full screenshot'") },
